...
@section('title', 'Kelas | SMK Lando Bulili Sigi')
      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          ...
          <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('kelas.create') }}" class="btn btn-md btn-neutral">Tambah Kelas</a>
          </div>
        </div>
      </div>
    </div>
                ...
                @foreach ($kelas as $data)
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="{{ route('kelas.edit', $data->id) }}" data-id="{{ $data->id }}" class="btn btn-sm btn-warning btn-edit">
                      ...
                      <form action="{{ route('kelas.destroy', $data->id) }}" method="POST" class="d-inline swal-confirm">
                          @csrf
                          @method('DELETE')
